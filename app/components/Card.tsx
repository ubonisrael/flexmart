...
const Card = ({ product }: { product: Product }) => {
  ...
  return (
    <div className="relative w-full h-84 p-4 bg-slate-100 shadow hover:shadow-md rounded-lg hover:bg-white hover:-translate-y-2 transition-all ease-in-out duration-300">
      ...
      <p className="absolute top-4 right-4 p-1 text-orange-700 bg-orange-300 rounded-bl-2xl">
      ...
      <div className="w-full grid gap-1 md:flex">
        ...
        <button
          className="w-full md:flex-1 h-12 flex items-center justify-center gap-1 text-white hover:font-bold bg-orange-400 border-0 rounded-md hover:bg-orange-800"
          onClick={() => {
